        ...
        <div class="card">
            <div class="card-header bg-success">
                <div class="d-flex align-items-center">
                    <h4 class="card-title text-light">Edit User</h4>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-6">
                            <div class="form-group ">
                                ...
                                <input id="inputFloatingLabel" name="name" value="{{ $user->name }}" type="text" class="form-control input-border-bottom" required>
                            </div>
                        </div>
                    </div>
                </div>
