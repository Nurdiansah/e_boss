...
<div class="row mr-3">
    ...
    <div class="col-sm-4 col-xs-12 d-flex justify-content-center ">
        ...
        <img src="{{asset('/img/profile.jpeg')}}" alt="..." class="rounded-circle  ml-3 " width="50%" height="40%">
        ...
        <div class="card">
            <div class="card-header bg-primary">
                <div class="d-flex align-items-center">
                    <h4 class="card-title text-light">Detail Profile</h4>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-6">
                            ...
                            <div class="form-group ">
                                ...
                                <input id="inputFloatingLabel" name="name" value="{{ $user->email }}" type="text" class="form-control input-border-bottom" required disabled>
                            </div>
                            <div class="form-group ">
