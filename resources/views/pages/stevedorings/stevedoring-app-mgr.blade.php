            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        <h4 class="card-title">Daftar Approval Stevedoring</h4>
                        ...
                        <table id="add-row" class="display table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($stevedoring->status == 5)
                                        <span class="badge badge-warning">Validasi</span>
                                        @endif
                                    </td>
                                    <td>
                                        <a href="{{route('stevedoring.app.mgr.detail', $stevedoring->id)}}">
