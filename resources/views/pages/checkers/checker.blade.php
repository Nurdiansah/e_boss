...
<div class="page-inner">
    <div class="page-header">
        <h4 class="page-title">Checker</h4>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        <h4 class="card-title">Daftar Checker</h4>
                        ...
                        <div class="modal fade" id="modalAdd" tabindex="-1" role="dialog" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <form action="{{route('checker.store')}}" name="form" method="POST">
                                        @csrf
                    ...
                    <div class="table-responsive">
                        <table id="basic-datatables" class="display table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td> <a href="{{route('checker.show', $checker->id)}}"> {{$checker->name}} </a></td>
                                    <td>{{$checker->created_at}}</td>
                                    <td>{{$checker->updated_at}}</td>
                                    <td>
                                        <!-- route('checker.edit', $checker->id -->
                                        <a href="">
                                            <a href="{{route('checker.edit', $checker->id)}}"><button class="btn btn-success"><i class="fa fa-edit"></i></button></a>
                                            <button class="btn btn-danger" data-toggle="modal" data-target="#modalDelete&id={{ $checker->id }}"><i class="fa fa-trash"></i></button>
                                        </a>
                                    </td>
                                </tr>

                                <!-- Modal Delete -->
                                <div class="modal fade" id="modalDelete&id={{ $checker->id }}" tabindex="-1" role="dialog" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{route('checker.delete', $checker->id)}}" name="form" method="POST">
                                                @method('DELETE')
                                                @csrf
                                                <input type="hidden" name="id" value="">
                                                <div class="perhitungan">
                                                    <div class="modal-body">
                                                        <h4 class="text-center">Apakah anda yakin ingin menghapus checker {{$checker->name}} ?</h4>
                                                    </div>
                                                    <div class="modal-footer ">
